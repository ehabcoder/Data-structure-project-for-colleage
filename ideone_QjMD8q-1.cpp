...
bool isDigit(string n){//return true if string is number;
    ...
    if((int(n[i])>=60&&int(n[i])<=90)||(int(n[i])>=97&&int(n[i])<=122))
        return false;
        }
    return true;
}
...
int main()
{
    char pass[10],password[10]="vortex";
    ...
    if (strcmp(pass,password)==0){
        ...
        if(number>=3){
            system("cls");
             system("color c");
            cout<<"\n\n\t\t\tthe pass is wrong do not tray again:\n\n ";
            cout<<"\t\t\tThis Project was developed by Vortex team!\n\n\t\t\tthank you for your time.\n\n\n\n";
            number=0;
            return 0;
        }
            cout<<"\n\nWrong password!!\a";
...
if(start==NULL){
    ...
    if((!(isDigit(d)&&isDigit(m)&&isDigit(y)))||dd>31||dd<=0||mm>12||mm<=0){
            cout<<mm<<"  "<<yy<<"\n";
...
int edit(node *start){
    ...
    case 1: {cout<<"\n\t\t\tEnter the new name: ";
            ...
            kk:
            cin>>nam;
            if(isDigit(nam)){//check if string is alphabetical or not
    ...
    case 7: {
        cout<<"\n\t\t\tEnter the new Date of birth: "; string day,month,year;
                ...
                if((!(isDigit(day)&&isDigit(month)&&isDigit(year)))||dd>31||dd<=0||mm>12||mm<=0){
                    cout<<"\t\t\tPlease enter a valid date of birth: ";
                goto fg;
                }
    else{
